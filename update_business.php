                        ...
                        <div class="col-lg-12 row p-0 m-0">
                            ...
                            <div class="col-lg-4">
                                ...
                                <span class='float-right'>
                                    <a href='updatebusiness.php?updatebusiness=$id' title='Update Profile of $title'data-toggle='modal' data-target='#exampleModal'><i class='fa fa-pencil fa-lg'></i></a>
                                </span>";
                                    }
                                ?>
                            </div>
